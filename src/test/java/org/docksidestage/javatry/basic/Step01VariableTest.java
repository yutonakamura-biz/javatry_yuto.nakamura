...
public class Step01VariableTest extends PlainTestCase {
    ...
    // done jflute 次回1on1で余談のし忘れをする (2026/07/23)
    // nullの変数を+で連結すると、"null" になるのは、そのプログラミング言語の決め。
    // 他の言語だと、空文字になったりエラーになったり、色々と変わります。
    // Javaの "null" って出てくる挙動のメリデメ:
    // デメリット: 本番で画面/メールにnullって出やすくて体裁が悪い(なぞ文字列)。
    // メリット: $ログとか場合分け(空文字 or null)、あと開発時は画面でnullって出た方がわかやすい。
    // 些細なことでもメリデメを考えてみると出るもの。
    // 大きさが同じとは限らない。それぞれ大きいメリット小さいメリットある。
    // サービスのどの時期なのかによっても変わるかも。
    // "null" って出ちゃってもいいから、システムがなんとなく動く方が良い時期もあるかも。
    // ↓ ここでの学びは...
    // null自体の話は忘れてもいいので、メリデメって難しいもの、複雑なものってことを知ること。
    // どんな選択肢でも絶対にメリデメがあって、100点のほとんどない。
    ...
    // #1on1: ぼく(jflute)は論文を書いてないので参考文献の書き方わかんないやー (2026/08/19)
